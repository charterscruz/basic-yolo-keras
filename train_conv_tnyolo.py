...
def _main_(args):
    ...
    train_imgs, train_labels = parse_annotation_img_sequences(
    ...
    if os.path.exists(config['valid']['valid_annot_folder']):
        valid_imgs, valid_labels = parse_annotation_img_sequences(
    ...
    #   Construct the model 
    ###############################
    yolo_conv_lstm = TinyYoloTimeDist(backend         = config['model']['backend'],
